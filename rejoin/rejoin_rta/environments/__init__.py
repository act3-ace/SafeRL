...
class BaseEnv(gym.Env):
    def __init__(self, config):
        ...
        self.obs_integration = self.config['obs']['integration'](self.config['obs'])
        self.reward_integration = self.config['reward']['integration'](self.config["reward"])
        self.constraints_integration = self.config['constraints']['integration'](self.config['constraints'])
